...
import aweLib from 'webpacklib';
import howLongUntilLunch from 'rolluplib';
...
function App() {
  ...
  const onClick = async () => {
    ...
    console.log(await howLongUntilLunch());

    const d = new aweLib.Dog('D')
    console.log(await d.getName());
